...
☑ Accepted an email invitation to the [EC 410/510 GitHub organization](https://github.com/orgs/uo-ec510-2020-spring/).
...
- P1: Invite P2 to join you as a collaborator on the "test" GitHub repo that you created earlier. (Click the *Settings* tab of your repo. Then *Manage Access* -> *Invite teams of people*.)
...
- Deadline: Due a week from today.

---

# Aside: R Markdown

All of your assignments must be completed using R Markdown. I'm going to provide a template for you, but you should definitely consider taking a looking a these resources if you aren't familiar with R Markdown.
...
pagedown::chrome_print("02-git.html", output = "02-git.pdf")
```