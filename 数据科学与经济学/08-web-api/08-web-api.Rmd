...
subtitle: "Lecture 8: Webscraping: (2) Client-side and APIs"
author:
...
*Note: I used to have a disclaimer here discussing World Rugby's Terms and Conditions for re-use of its data. However, given the [HiQ vs. LinkedIn](https://en.wikipedia.org/wiki/HiQ_Labs_v._LinkedIn#Implications) court ruling that we discussed in the previous lecture, that seems redundant now.*
