...
subtitle: "Lecture 4: Data cleaning and wrangling: (1) Tidyverse"
...
The creators of dplyr are planning to release [version 1.0.0](https://www.tidyverse.org/blog/2020/03/dplyr-1-0-0-is-coming-soon/) of the package in a few weeks.
...
pagedown::chrome_print("04-tidyverse.html", output = "04-tidyverse.pdf")
```